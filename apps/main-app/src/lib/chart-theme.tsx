// Same styling as apps/ai-control-tower/src/lib/chart-theme.tsx —
// duplicated rather than shared, since it's a small, charting-library-
// specific concern (Recharts prop shapes), not a design-system primitive.
// Worth extracting to a shared package if a 3rd app ends up needing it too.
